...
<p> Think about it, if there was, don't you think the holy grail would have been easily found by now? especially with algo trading and computers processing every scenario with these known indicators. That is why you need to find an edge and doesnt rely on known methods that can be used against you by large institutions. The AI revolution will give us a small window to take serious advantage of the big guys and get ahead of them for once. Even if you don't want to use the expet advisor to trade you can turn off live trading and take advantage of using the Ai to help you with trade paralysis. If your trading system matches the AI prediction then you have a high probability the trade will go your way and to fire in the order</p>
