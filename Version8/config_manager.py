"""
GGTH Predictor Configuration Manager
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="GGTH Predictor Configuration Utility")
    ...
    if args.show or (not args.set_mt5_path and not args.auto_detect):
        config.print_config()
